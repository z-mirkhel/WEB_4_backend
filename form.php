  ...
  <body>
    <header class="header">
      <div class="content-head">
        ...
        <div class="header__text">WEB_4</div>
      </div>  
    </header>
      ...
      <div class="formm">
        ...
        <form id="form" class="form__body" method="post" action="">
            ...
            <div>
                ...
                <input class="form-control pole shadow bg-white rounded form__input _req
                <?php
                ...
                ?>
                "
                id="names" type="text" name="name" placeholder="Имя" value= "
                <?php 
                print($value['name']); 
                ?>" >
            ...
            <div>
                ...
                <input class="form-control pole shadow bg-white rounded form__input _req _email
                <?php
                ...
                <div>
                    ...
                    <textarea id="comment" class="form-control shadow bg-white rounded form__input _req  
                    <?php
                    if($message['bio'] == TRUE){
                        print('_error');
                    }
                    ?> 
                    _req" type="text" name="bio" placeholder="Биография" >
                    <?php 
                    print($value['bio']); 
                    ?>
                    </textarea>
                ...
                <input class="form-check-input checkbox__input _req
                ...
                ?>
                >
                <label class="checkbox__label" for="userAgreement">Согласие на <a>обработку персональных данных</a>.<span>*</span></label>
                </div>
            <div class="text-danger err "
            <?php
            if(!$error['agree']){
